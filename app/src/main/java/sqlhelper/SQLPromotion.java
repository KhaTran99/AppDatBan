...
public class SQLPromotion extends SQLiteOpenHelper {
    static final String DB_NAME = "ListPromotion.db";
    ...
    Cursor cursor;
    public SQLPromotion( Context context) {
    ...
    public void insertPromotion (Promotion promotion) {
        ...
        contentValues.put(PROMOTION_ICON,promotion.getIcon());
